...
def get_client_exchange(exchange_name = "", acc_info='', symbol='BTC', quote="USDT", session_key = '' ,run_mode=False):
    """
    ...
    ## Goi Api bao san dang chạy => session_key, exchange => True or False
    #if False:
        # return
