...
class PoloniexBalanceChecker:
                    ...
                    try:
                        ...
                        if asset_symbol == 'USDT':
                            ...
                            try:
                                ...
                                logger_error.error(f"⚠️ Could not get ticker for {asset_symbol}_USDT: {ticker_error}")
                                ...
                                try:
                                    ...
                                    logger_error.error(f"⚠️ Could not get price for {asset_symbol}: {price_error}")
                                    price = 0.0
    ...
    def check_balance(self, asset_filter=None):
        ...
        """
        logger_access.info("🚀 Starting Poloniex Balance Check...")
